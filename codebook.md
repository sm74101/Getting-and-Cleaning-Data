...
Save data table objects to a tab-delimited text file called `Dataset-HumanActivityRecognitionUsingSmartphones.txt`.


```r
f <- file.path(path, "Dataset-HumanActivityRecognitionUsingSmartphones.txt")
